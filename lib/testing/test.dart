...
//             UserId = dto.UserId,
//             InstallmentAvailable = dto.InstallmentAvailable, // New field
//             ImageUrls = imageUrls,
//             Status = "Pending"
//         };
...
//     {
//         var products = await _dbContext.Products.Where(p => p.Status == "Approved").ToListAsync();
//         return Ok(products);
//     }
...
//         product.InstallmentAvailable = dto.InstallmentAvailable; // New field
...
//                     p.Price,
//                     p.Discount,
//                     p.InstallmentAvailable, // New field
//                     p.ImageUrls
//                 })
//             });
//         }
